  ...
  const mockTracking = {
    ...
    events: [
      ...
      },
      {
        ...
        completed: true,
        description: 'Container in transit via Singapore hub'
      },
      {
        ...
        completed: true,
        description: 'Cleared customs successfully'
      },
      {
        status: 'In Transit',
      ...
      },
      {
        ...
        date: 'Pending',
        completed: false,
        description: 'Final delivery to warehouse'
      },
    ]
  }
        ...
        >
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-1">
                    Order #{tracking.orderId} • {tracking.carrier}
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="card">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">#{tracking.orderId}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium capitalize">{tracking.method} Freight</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="card">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 mb-1">Origin</p>
                ...
                <div>
                  <p className="text-gray-600 dark:text-gray-400 mb-1">Destination</p>
                  <p className="font-medium flex items-center space-x-2">
                ...
                <div>
                  <p className="text-gray-600 dark:text-gray-400 mb-1">Est. Delivery</p>
        ...
        <div className="card text-center py-12">
          ...
          <div className="max-w-md mx-auto text-left">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
              <strong>Where to find tracking number:</strong>
            </p>
