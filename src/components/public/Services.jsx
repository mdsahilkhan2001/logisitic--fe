      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-dark-bg">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400">Simple and transparent workflow from concept to delivery</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {process.map((item, index) => (
                ...
                >
                  ...
                  {index < process.length - 1 && <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-primary-300 -ml-3"></div>}
                </motion.div>
              ))}
            </div>
          </div>
